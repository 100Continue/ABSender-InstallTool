...
ABSender: ABSender.c ap_release.h
	gcc ABSender.c ap_release.h -o ABSender -I/usr/local/apr/include/apr-1 -I/usr/local/apr-util/include/apr-1 -L/usr/local/apr/lib -lapr-1 `pkg-config apr-1 --cflags` -laprutil-1 -lm
